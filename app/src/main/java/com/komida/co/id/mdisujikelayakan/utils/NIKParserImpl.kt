...
import com.komida.co.id.mdisujikelayakan.model.NIKDistrict
import com.komida.co.id.mdisujikelayakan.model.NIKParserResponse
import com.komida.co.id.mdisujikelayakan.model.NIKProvince
import com.komida.co.id.mdisujikelayakan.model.NIKRegency
...
class NIKParserImpl(
    ...
    override fun parseNik(nik: String): NIKParserResponse {
        ...
        if (province == null || regency == null  || !isLastFourDigitMoreThanZero || birthDate == "" || birthMonth == "" || birthYear == ""
        ) {
            return NIKParserResponse(nik = nik, isValid = false)
        }
    ...
    private fun getDistrict(nik: String): NIKDistrict? {
        ...
        println("DISTRICTCODE"+districtCode)
