...
object ViewAnimation {
    ...
    fun expand(v: View, animListener: AnimListener? = null) {
    ...
    fun flyInDown(v: View, animListener: AnimListener? = null) {
        v.visibility = View.VISIBLE
        v.alpha = 0.0f
        v.translationY = 0f
    ...
    fun flyOutDown(v: View, animListener: AnimListener? = null) {
        v.visibility = View.VISIBLE
        v.alpha = 1.0f
        v.translationY = 0f
        // Prepare the View for the animation
    ...
    fun fadeIn(v: View, animListener: AnimListener? = null) {
        v.visibility = View.GONE
        v.alpha = 0.0f
        // Prepare the View for the animation
        v.animate()
    ...
    fun fadeOut(v: View, animListener: AnimListener? = null) {
        v.alpha = 1.0f
        // Prepare the View for the animation
        v.animate()
            .setDuration(500)
    ...
    fun showScale(v: View, animListener: AnimListener? = null) {
        v.animate()
            .scaleY(1f)
            .scaleX(1f)
            .setDuration(200)
    ...
    fun hideScale(v: View, animListener: AnimListener? = null) {
        v.animate()
            .scaleY(0f)
            .scaleX(0f)
            .setDuration(200)
